...
export function EvalAnimatedAccordionSlot({ motionState, children }: Props) {
  ...
  return (
    <motion.div
      ...
      className={`mb-2 grid ease-[cubic-bezier(0.4,0,0.2,1)] last:mb-0 ${heightCollapsed ? "overflow-hidden !mb-0" : "overflow-visible"}`}
      style={{
    ...
    >
      <div
        className={`min-h-0 ${heightCollapsed ? "overflow-hidden" : "overflow-visible"}`}
      >
        {children}
      </div>
    </motion.div>
